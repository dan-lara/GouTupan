...
const uint8_t Font8x8_FR[224][8] PROGMEM = {
    ...
    {0x0C, 0x0E, 0x0C, 0x0C, 0x0C, 0x0C, 0x3F, 0x00}, // 0 (0x30)
    {0x1E, 0x33, 0x30, 0x1C, 0x06, 0x33, 0x3F, 0x00}, // 1 (0x31)
    {0x1E, 0x33, 0x30, 0x1C, 0x30, 0x33, 0x1E, 0x00}, // 2 (0x32)
    {0x38, 0x3C, 0x36, 0x33, 0x7F, 0x30, 0x30, 0x00}, // 3 (0x33)
    {0x3F, 0x03, 0x1F, 0x30, 0x30, 0x33, 0x1E, 0x00}, // 4 (0x34)
    {0x1C, 0x06, 0x03, 0x1F, 0x33, 0x33, 0x1E, 0x00}, // 5 (0x35)
    {0x3F, 0x33, 0x30, 0x18, 0x0C, 0x0C, 0x0C, 0x00}, // 6 (0x36)
    {0x1E, 0x33, 0x33, 0x1E, 0x33, 0x33, 0x1E, 0x00}, // 7 (0x37)
    {0x1E, 0x33, 0x33, 0x3E, 0x30, 0x18, 0x0E, 0x00}, // 8 (0x38)
    {0x3E, 0x63, 0x63, 0x7F, 0x63, 0x63, 0x63, 0x00}, // 9 (0x39)
    ...
    {0x7E, 0x63, 0x63, 0x7E, 0x63, 0x63, 0x7E, 0x00}, // A (0x41)
    {0x3E, 0x63, 0x03, 0x03, 0x03, 0x63, 0x3E, 0x00}, // B (0x42)
    {0x7E, 0x63, 0x63, 0x63, 0x63, 0x63, 0x7E, 0x00}, // C (0x43)
    {0x7F, 0x03, 0x03, 0x1F, 0x03, 0x03, 0x7F, 0x00}, // D (0x44)
    {0x7F, 0x03, 0x03, 0x1F, 0x03, 0x03, 0x03, 0x00}, // E (0x45)
    {0x3E, 0x63, 0x03, 0x73, 0x63, 0x63, 0x3E, 0x00}, // F (0x46)
    {0x63, 0x63, 0x63, 0x7F, 0x63, 0x63, 0x63, 0x00}, // G (0x47)
    {0x3F, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x3F, 0x00}, // H (0x48)
    {0x30, 0x30, 0x30, 0x30, 0x30, 0x33, 0x1E, 0x00}, // I (0x49)
    {0x63, 0x33, 0x1B, 0x0F, 0x1B, 0x33, 0x63, 0x00}, // J (0x4A)
    {0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x7F, 0x00}, // K (0x4B)
    {0x63, 0x77, 0x7F, 0x6B, 0x63, 0x63, 0x63, 0x00}, // L (0x4C)
    {0x63, 0x67, 0x6F, 0x7B, 0x73, 0x63, 0x63, 0x00}, // M (0x4D)
    {0x1C, 0x36, 0x63, 0x63, 0x63, 0x36, 0x1C, 0x00}, // N (0x4E)
    {0x7E, 0x63, 0x63, 0x7E, 0x03, 0x03, 0x03, 0x00}, // O (0x4F)
    {0x1C, 0x36, 0x63, 0x63, 0x7B, 0x36, 0x1C, 0x18}, // P (0x50)
    {0x7E, 0x63, 0x63, 0x7E, 0x1B, 0x33, 0x63, 0x00}, // Q (0x51)
    {0x3E, 0x63, 0x03, 0x3E, 0x60, 0x63, 0x3E, 0x00}, // R (0x52)
    {0x7F, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x00}, // S (0x53)
    {0x63, 0x63, 0x63, 0x63, 0x63, 0x63, 0x3E, 0x00}, // T (0x54)
    {0x63, 0x63, 0x63, 0x36, 0x36, 0x1C, 0x08, 0x00}, // U (0x55)
    {0x63, 0x63, 0x6B, 0x7F, 0x77, 0x63, 0x63, 0x00}, // V (0x56)
    {0x63, 0x36, 0x1C, 0x08, 0x1C, 0x36, 0x63, 0x00}, // W (0x57)
    {0x63, 0x36, 0x1C, 0x08, 0x08, 0x08, 0x08, 0x00}, // X (0x58)
    {0x7F, 0x60, 0x30, 0x18, 0x0C, 0x06, 0x7F, 0x00}, // Y (0x59)
    {0x00, 0x1E, 0x30, 0x3E, 0x33, 0x33, 0x6E, 0x00}, // Z (0x5A)
    ...
    {0x07, 0x06, 0x06, 0x3E, 0x66, 0x66, 0x3B, 0x00}, // a (0x61)
    {0x00, 0x1E, 0x33, 0x03, 0x03, 0x33, 0x1E, 0x00}, // b (0x62)
    {0x38, 0x30, 0x30, 0x3E, 0x33, 0x33, 0x6E, 0x00}, // c (0x63)
    {0x00, 0x1E, 0x33, 0x3F, 0x03, 0x33, 0x1E, 0x00}, // d (0x64)
    {0x1C, 0x36, 0x06, 0x0F, 0x06, 0x06, 0x0F, 0x00}, // e (0x65)
    {0x00, 0x6E, 0x33, 0x33, 0x3E, 0x30, 0x1E, 0x00}, // f (0x66)
    {0x07, 0x06, 0x06, 0x3E, 0x66, 0x66, 0x67, 0x00}, // g (0x67)
    {0x0C, 0x00, 0x0E, 0x0C, 0x0C, 0x0C, 0x1E, 0x00}, // h (0x68)
    {0x30, 0x00, 0x30, 0x30, 0x30, 0x33, 0x1E, 0x00}, // i (0x69)
    {0x07, 0x06, 0x66, 0x36, 0x1E, 0x36, 0x67, 0x00}, // j (0x6A)
    {0x0E, 0x0C, 0x0C, 0x0C, 0x0C, 0x0C, 0x1E, 0x00}, // k (0x6B)
    {0x00, 0x37, 0x7F, 0x6B, 0x6B, 0x63, 0x63, 0x00}, // l (0x6C)
    {0x00, 0x1F, 0x33, 0x33, 0x33, 0x33, 0x33, 0x00}, // m (0x6D)
    {0x00, 0x1E, 0x33, 0x33, 0x33, 0x33, 0x1E, 0x00}, // n (0x6E)
    {0x00, 0x3B, 0x66, 0x66, 0x3E, 0x06, 0x0F, 0x00}, // o (0x6F)
    {0x00, 0x6E, 0x33, 0x33, 0x3E, 0x30, 0x78, 0x00}, // p (0x70)
    {0x00, 0x3B, 0x6E, 0x66, 0x06, 0x06, 0x0F, 0x00}, // q (0x71)
    {0x00, 0x3E, 0x03, 0x1E, 0x30, 0x33, 0x1E, 0x00}, // r (0x72)
    {0x08, 0x0C, 0x3E, 0x0C, 0x0C, 0x2C, 0x18, 0x00}, // s (0x73)
    {0x00, 0x33, 0x33, 0x33, 0x33, 0x33, 0x6E, 0x00}, // t (0x74)
    {0x00, 0x33, 0x33, 0x33, 0x1E, 0x0C, 0x0C, 0x00}, // u (0x75)
    {0x00, 0x63, 0x6B, 0x6B, 0x7F, 0x36, 0x36, 0x00}, // v (0x76)
    {0x00, 0x63, 0x36, 0x1C, 0x1C, 0x36, 0x63, 0x00}, // w (0x77)
    {0x00, 0x33, 0x33, 0x33, 0x3E, 0x30, 0x1E, 0x00}, // x (0x78)
    {0x00, 0x3F, 0x19, 0x0C, 0x06, 0x33, 0x3F, 0x00}, // y (0x79)
    {0x00, 0x21, 0x12, 0x0C, 0x0C, 0x12, 0x21, 0x00}, // z (0x7A)
